...
Genuine partnership between human and AI. Full principles in global AGENTS.md (`~/.Codex/AGENTS.md`).

---

## Wiki Knowledge Base

Compiled knowledge at `_wiki/`. Schema: `~/.Codex/wiki/SCHEMA.md`. Shared concepts: `~/.Codex/wiki/concepts/`. Maintain via `/wiki` (catchup + health check) or `/wiki bootstrap` (new repo). Provenance rule: every claim cites source.
