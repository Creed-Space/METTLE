...
Usage:
    # Run all attacks
    python scripts/run_mettle_red_council.py \\
...
async def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/run_mettle_red_council.py --scenarios tests/redteam/scenarios/mettle_red_council_attacks.yaml
  python scripts/run_mettle_red_council.py --scenarios tests/redteam/scenarios/mettle_red_council_attacks.yaml --severity-threshold 8
        """,
    )
    parser.add_argument(
        "--scenarios",
